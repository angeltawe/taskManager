...
export function UserProfileModal({ isOpen, onClose, user, tasks }: UserProfileModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-xl border-none shadow-2xl p-0 overflow-hidden">
        ...
        <div className="px-8 pt-16 pb-6">
          ...
          <Tabs defaultValue="overview" className="w-full mt-8">
            <TabsList className="bg-secondary/50 p-1 w-full flex">
              <TabsTrigger value="overview" className="flex-1 gap-2 font-bold"><Activity className="h-4 w-4" /> Overview</TabsTrigger>
              <TabsTrigger value="settings" className="flex-1 gap-2 font-bold"><Settings className="h-4 w-4" /> Edit Profile</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="overview" className="mt-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3 text-[11px] text-muted-foreground font-medium px-1">
                  ...
                  Joined {user.createdAt ? format(user.createdAt.toDate(), 'MMMM yyyy') : 'Recently'}
                </div>
              </div>
            </TabsContent>
        ...
        <DialogFooter className="px-8 py-4 bg-muted/5 border-t border-border/40">
